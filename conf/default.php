...
$conf['severities']    = 'Minor Bug,Feature Request,Major Bug';   // Use captcha on by default $conf['email_subject_template'] = "The bug report @ID@ in the project @PROJECT@ changed";$conf['email_body_template'] = "Hi, \n\nYou receive this bug change notification as you report the bug #@ID@ in the project '@PROJECT@'.\n\n--------------------------------------------------------------------------------\n\nWhat : @FIELD@\n\nRemoved: @OLDVALUE@\n\nAdded: @VALUE@";
